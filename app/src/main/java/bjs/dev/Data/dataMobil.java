...
public class dataMobil {
    ...
    private  static String []  personName={ "Person 1", "Person 2", "Person 3", "Person 4", "Person 5", "Person 6", "Person 7","Person 8", "Person 9", "Person 10"};

    private  static String[] personDdetail={   "Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah yang masih harus belajar dan berbuat.",
    ...
    private static int[] personImage={
            R.drawable.bugati_centodici,
            R.drawable.bugati_chiron,
            R.drawable.bugati_divo,
            R.drawable.koenigseg,
            R.drawable.bugati_la,
            R.drawable.lamborgini_sian,
            R.drawable.lamborgini_veneno,
            R.drawable.mercedes_maybach,
            R.drawable.pagani_huayra,
            R.drawable.rools_roys
    };
...
for (int position =0;position < personName.length;position++  ){
    ...
    mobil.setName(personName[position]);
    mobil.setDetail(personDdetail[position]);
    mobil.setPhoto(personImage[position]);
    list.add(mobil);
